...
namespace Model.Abilities
{
	public class FormationTargetAbility2: GameCommand, IAbility, ITargetAbility //not an AbilityCommand
	{
		...
		//dictionary: commanded unit, attached formationTargetAbility: just wraps the world position target
		//the commander sets the target. The commanded unit still has its abilities, and this one
		//add the formation target: I target: check method to ITarget interface
		//for formation target: exact point: 
		//different types of targets, other types of checks:
