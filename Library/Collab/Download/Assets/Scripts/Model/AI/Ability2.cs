...
namespace Model.AI
{
	public class Ability2 : GameCommand
	{
		...
		public override GameCommandStatus FixedStep()
		{
			...
			// dvscode: _unit.targetPrioritiesHack [2] = target;   //THIS IS PART OF THE hack
		...
		private void ExecuteAbility(){
			casting = false;
			castTick = 0;
			// dvscode: var command = _buffTargetCommandFactory.Create(Buffs.MaxHpBuff, new BuffData {strength = 10, duration = 100, receiver = _unit.Target, sender = _unit});
