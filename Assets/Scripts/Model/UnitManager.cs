...
namespace Model
{
    public class UnitManager
    {
        ...
        private readonly IFactory<UnitData, AllianceType, UnitModel> _unitFactory; //this ifactory is bound in the installer

        private readonly AbilityRepository _abilityRepository;
        private readonly CommandProcessor _commandProcessor;


		public UnitManager(WorldModel worldModel, CommandProcessor commandProcessor,  IFactory<UnitData, AllianceType,
			UnitModel> unitFactory, AbilityRepository abilityRepository
			)
        {
        ...
        public UnitModel SpawnUnit(UnitData unitData, AllianceType alliance, WorldPosition position)
        {
            ...
            var unit = _unitFactory.Create(unitData, alliance); //the unit factory doesn't go through the command processor and is therefore irrelevent
